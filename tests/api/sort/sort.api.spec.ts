...
test.describe("Products API Sorting Smoke Tests", () => {
  ...
  test.afterAll(async () => {
    // Закрываем контекст после всех тестов в describe
  ...
  test("should sort products by Price (High - Low)", async () => {
  ...
  test("should sort products by CO₂ Rating (A - E)", async () => {
  ...
  test("should sort products by CO₂ Rating (E - A)", async () => {
